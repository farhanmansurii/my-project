    ...
    <div
      ...
      <div className="absolute inset-0 z-10 transition-all duration-300  group-hover:opacity-100">
        ...
        <div className="absolute bottom-0 left-0 w-full  h-full px-4 py-2 flex flex-col justify-end">
          <h3 className="text-lg font-bold  ">Episodesadas {episode.number}</h3>
      ...
      <Image
        className="object-contain object-center  aspect-video transition-all duration-100 transform group-hover:scale-[102%]"
        src={imageUrl}
